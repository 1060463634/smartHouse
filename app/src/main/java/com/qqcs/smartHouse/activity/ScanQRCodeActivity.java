...
import com.qqcs.smartHouse.decoding.CaptureActivityHandler;
import com.qqcs.smartHouse.decoding.InactivityTimer;

import com.qqcs.smartHouse.utils.AESUtils;
import com.qqcs.smartHouse.utils.ToastUtil;
import com.qqcs.smartHouse.widgets.ViewfinderView;
...
public class ScanQRCodeActivity extends BaseActivity implements SurfaceHolder.Callback {
    ...
    private void handleQrString(String url){
        try {
            String familyId = AESUtils.decrypt(url,
                    Constants.PASSWORD_ENCRYPT_SEED, AESUtils.MODE_BASE64);
            Intent intent = new Intent(this,QrHomeDetailActivity.class);
